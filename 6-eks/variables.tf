...
variable "kubernetes_version"  { type = string  default = "1.30" } # update as needed

variable "vpc_id"              { type = string }
variable "private_subnet_ids"  { type = list(string) }
variable "public_subnet_ids"   { type = list(string) default = [] } # if you plan public ALBs
...
# Node group
variable "node_instance_types" { type = list(string) default = ["t2.micro"] }
