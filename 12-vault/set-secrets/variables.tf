...
variable "kv_mount"       { type = string  default = "kv" }
variable "team"           { type = string  default = "myteam" }
variable "app"            { type = string  default = "myapp" }
variable "app_namespace"  { type = string  default = "prod" }
variable "eso_sa_name"    { type = string  default = "eso-myapp-sa" }